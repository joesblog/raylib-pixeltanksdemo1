...
PROJECT_NAME          ?= PixelTanksDemo1
PROJECT_VERSION       ?= 1.0
PROJECT_BUILD_PATH    ?= .

RAYLIB_PATH           ?= "C:\_dev\raylib\raylib"
...
BUILD_WEB_EMIT_RESOURCES ?= FALSE
...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    ifeq ($(BUILD_WEB_RESOURCES),TRUE)
        LDFLAGS += --preload-file $(BUILD_WEB_RESOURCES_PATH)@$(BUILD_WEB_RESOURCES_PATH)
    endif
	
	ifeq ($(BUILD_WEB_EMIT_RESOURCES),TRUE)
        LDFLAGS += --embed-file $(BUILD_WEB_RESOURCES_PATH)
    endif
